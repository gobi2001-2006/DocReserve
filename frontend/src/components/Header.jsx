...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-blue-600 rounded-lg px-6 md:px-20'>
        <div className='md:w-1/2 flex flex-col items-start justfy-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
